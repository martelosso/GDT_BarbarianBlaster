...
func _process(delta: float) -> void:
	...
	# Since everything inside _process updates every frame, at this point of the code we don't have access to the updated raycast, so we use the line bellow to force an update:
